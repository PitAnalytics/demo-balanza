...
$app->get('/api/bseg/concepto', \App\Controllers\BsegController::class.':concepto');
$app->get('/api/bseg/super-concepto', \App\Controllers\BsegController::class.':superConcepto');
//
/******************/
/****EJECUTAMOS****/
/******************/
